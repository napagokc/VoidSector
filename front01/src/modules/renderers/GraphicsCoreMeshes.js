...
export class MarkerCircle extends React.Component {
	render() {
		let texture;
		if (this.props.thickness === 'thin') texture = 'markers/circle_thin.png';
		else if (this.props.radius < 20) texture = 'markers/circle_bold.png';
		else if (this.props.radius > 100) texture = 'markers/circle_thin.png';
		else texture = 'markers/circle_normal.png';
...
export function MeshObject(props) {
	...
	let size_array = props.size_array ? props.size_array : [props.size, props.size];
	...
	return (
		<mesh {...props} ref={meshRef} rotation={[0, 0, rotation]}>
			<boxGeometry args={[size_array[0], size_array[1], 0.1]} />
